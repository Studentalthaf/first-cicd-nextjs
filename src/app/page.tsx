...
import { SiNextdotjs, SiJavascript, SiLaravel, SiPhp, SiPython, SiGooglecolab, SiFigma } from 'react-icons/si';
...
const TiltedCard = dynamic(() => import("./components/TiltedCard/TiltedCard"), { ssr: false });
